...
Given the ideas on messaging, plus a few technical considerations, we've decided to stick to Open Sans as our default typeface. The reasoning being:


- Being a neutral, sans-serif Humanist typeface, it would keep the sober tone we wanted, but still friendly tone due to its width;
- It has good readability;
- It has several variants - five in terms of weight (300 Light, 400 Normal, Semi-Bold 600, Bold 700 and Extra Bold 800), plus each one in (true) italics, which totals it to 10 variants;
- It's an open font, with an Apache License.

Plus, Open Sans allows us for several different font pairings in the future, so it seemed like a good decision for now.
